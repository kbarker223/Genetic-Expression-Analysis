...
**PCA_Analysis.ipynb** — Runs PCA on standardized gene expression values using `sample_by_gene.parquet`, and produces plots of the first two principal components to measure gene variance between treatments and control.
